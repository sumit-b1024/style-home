...
class ProjectController extends Controller
{
    ...
    {
        $projects = ProjectDetail::select('detail_forms.project_duration','detail_forms.created_at as Designer_date','detail_forms.designer', 'customer_quizzes.preferred_bedroom', 'cust_users.first_name as cust_firstname','cust_users.last_name as cust_lastname',  'desi_users.first_name','desi_users.last_name','desi_users.id as userId', 'project_details.*')->join('detail_forms', 'detail_forms.id', 'project_details.detail_form_id')
