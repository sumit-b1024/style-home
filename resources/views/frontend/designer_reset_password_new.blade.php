        ...
        <div class="container">
            <div class="login-content">
                ...
                <div class="login-form">
                    ...
                    <form action="{{ route('frontend.designer.reset.password.new.post') }}" method="post">
                        @csrf
                        <input type="hidden" name="user_id" value="{{ $userId }}">
                        <p class="form-group form-row form-row-wide"> <label for="username">New Password <span
                        ...
                        <p class="form-group form-row form-row-wide"> <label for="username">Password Confirmation <span
                                    class="required">*</span></label>
                            <input type="password" class="input-text form-control" name="password_confirmation"
                                id="password_confirmation" value="">
                            <span class="help-block is-invalid"
                                style="color:red;">{{ $errors->first('password_confirmation') }}</span>

                        </p>
                        <input type="submit" class="btn btn-success btn-flat m-b-30 m-t-30" name="login" value="Reset">
                    </form>
                </div>
            </div>
        </div>
