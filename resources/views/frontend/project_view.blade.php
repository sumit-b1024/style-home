...
<div class="session_cont mt-5 pt-4 tabing_content">                
<div class="row">                    
 	<div class="col-lg-12">                   
	<nav>                    
	<div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">                      
	<a class="nav-item nav-link active show" id="nav-home-tab" data-toggle="tab" href="#nav-quiz" role="tab" aria-controls="nav-home" aria-selected="true">Quiz Details</a>                                          
	...
	<div class="tab-pane fade active show" id="nav-quiz" role="tabpanel" aria-labelledby="nav-home-tab">
	...
	<span class="ans_img"><img src="{{@$answer->getQuizAnswerImage()}}"></span> 
	<span class="bg-azure">{{@$answer->title}}</span>
	</div>
	<?php
	}
	?>
    ...
    @endif
    <p><b>When would you need this project done?</b>					   
	{{@$project->project_duration}}	</p>					  
